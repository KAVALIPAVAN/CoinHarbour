...
//       <h1 className="text-[#A1E00D] text-2xl md:text-4xl font-bold my-4">Invest in Just 4 Steps!</h1>
//           <p className="text-white text-lg md:text-xl">All it takes is 1 minute to start building your portfolio</p>
...
//             ].map((feature, index) => (
//               <div key={index} className="bg-[#0f0f0f] rounded-2xl  px-5 py-2 gap-2 lg:h-40">
