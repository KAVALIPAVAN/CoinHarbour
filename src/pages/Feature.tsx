...
const Feature = () => {
    return (
      <div className="w-[90%] mx-auto my-20 max-w-7xl px-4 md:px-8">
        <h2 className="text-[#A1E00D] rounded-2xl bg-[#191919] w-fit px-4 py-2 text-sm md:text-base">OUR FEATURES</h2>
        <h1 className="text-[#A1E00D] text-2xl md:text-4xl font-bold my-4">Why Choose CoinHarbour?</h1>
        <p className="text-white text-lg md:text-xl">We make investing simple, flexible, and accessible for everyone.</p>
  
        <div className="my-6 flex flex-col md:flex-row items-center lg:justify-between gap-10">
          {/* Features List */}
          <div className="w-full lg:w-[50%] grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-6">
            {[
